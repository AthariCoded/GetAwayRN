...
import { ProfileTitle, ProfileLabels, ProfilePicture } from "./styles";
...
// You can probably reuse the trip list component in the profile screen with some conditions
...
const ProfileOwnerTrips = ({ route }) => {
  ...
  const tripList = tripStore.trips
    ...
    .map((trip) => <ProfileOwnerTripItem trip={trip} key={trip.id} />);
